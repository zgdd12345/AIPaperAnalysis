...
import { registerPrefsScripts, testConnection as testPrefsConnection, openPromptManager as openPrefsPromptManager, } from "./modules/preferenceScript";
import { createZToolkit } from "./utils/ztoolkit";
import { cleanupPlugin, getPluginInstance, initializePlugin, } from "./modules/plugin";
...
async function onPrefsEvent(type, data) {
    switch (type) {
        ...
        case "openPromptManager":
            openPrefsPromptManager(data.window);
            break;
        default:
            return;
    }
