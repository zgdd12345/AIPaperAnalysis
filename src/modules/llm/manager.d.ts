 ...
 * 提供统一的接口来访问不同的LLM服务
 */
import type { ProviderType, ProviderConfig, ChatCompletionRequest, ChatCompletionResponse, LLMModel } from '../../types/llm';
export declare class LLMManager {
     ...
     * 发送聊天请求
     */
    chat(request: ChatCompletionRequest, providerType?: ProviderType): Promise<ChatCompletionResponse>;
    /**
     * 列出可用模型
     */
