...
__decorate([
    example
], BasicExampleFactory, "registerNotifier", null);
__decorate([
    example
], BasicExampleFactory, "exampleNotifierCallback", null);
__decorate([
    example
], BasicExampleFactory, "unregisterNotifier", null);
__decorate([
    example
...
__decorate([
    example
], KeyExampleFactory, "registerShortcuts", null);
__decorate([
    example
], KeyExampleFactory, "exampleShortcutLargerCallback", null);
__decorate([
    example
], KeyExampleFactory, "exampleShortcutSmallerCallback", null);
export class UIExampleFactory {
    ...
    static registerRightClickMenuPopup(win) {
        ...
        }, "before", win.document?.querySelector("#zotero-itemmenu-addontemplate-test"));
    }
...
__decorate([
    example
], UIExampleFactory, "registerStyleSheet", null);
__decorate([
    example
], UIExampleFactory, "registerRightClickMenuItem", null);
__decorate([
    example
], UIExampleFactory, "registerRightClickMenuPopup", null);
__decorate([
    example
], UIExampleFactory, "registerWindowMenuWithSeparator", null);
__decorate([
    example
], UIExampleFactory, "registerExtraColumn", null);
__decorate([
    example
], UIExampleFactory, "registerExtraColumnWithCustomCell", null);
__decorate([
    example
], UIExampleFactory, "registerItemPaneCustomInfoRow", null);
__decorate([
    example
], UIExampleFactory, "registerItemPaneSection", null);
__decorate([
    example
], UIExampleFactory, "registerReaderItemPaneSection", null);
export class PromptExampleFactory {
    ...
    static registerAnonymousCommandExample(window) {
        ztoolkit.Prompt.register([
            {
                id: "search",
                    ...
                    if (ids.length == 0) {
                        ...
                        text.split(/\s*(&&|\|\|)\s*/g).forEach((conditinString) => {
                            ...
                            if (conditions.length == 3 &&
                                ...
                                s.addCondition(conditions[0], conditions[1], conditions[2]);
                            }
                        });
        ...
        ztoolkit.Prompt.register([
            {
                ...
                callback(prompt) {
                    ...
                    const items = ztoolkit.getGlobal("ZoteroPane").getSelectedItems();
                    ztoolkit.getGlobal("alert")(`You select ${items.length} items!\n\n${items
...
__decorate([
    example
], PromptExampleFactory, "registerNormalCommandExample", null);
__decorate([
    example
], PromptExampleFactory, "registerAnonymousCommandExample", null);
__decorate([
    example
], PromptExampleFactory, "registerConditionalCommandExample", null);
export class HelperExampleFactory {
    static async dialogExample() {
        ...
        if (addon.data.alive)
            ztoolkit.getGlobal("alert")(`Close dialog with ${dialogData._lastButtonId}.\nCheckbox: ${dialogData.checkboxValue}\nInput: ${dialogData.inputValue}.`);
...
__decorate([
    example
], HelperExampleFactory, "dialogExample", null);
__decorate([
    example
], HelperExampleFactory, "clipboardExample", null);
__decorate([
    example
], HelperExampleFactory, "filePickerExample", null);
__decorate([
    example
], HelperExampleFactory, "progressWindowExample", null);
__decorate([
    example
], HelperExampleFactory, "vtableExample", null);
