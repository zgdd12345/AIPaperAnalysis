...
__decorate([example], BasicExampleFactory, "registerNotifier", null);
__decorate([example], BasicExampleFactory, "exampleNotifierCallback", null);
__decorate([example], BasicExampleFactory, "unregisterNotifier", null);
__decorate([example], BasicExampleFactory, "registerPrefs", null);
...
__decorate([example], KeyExampleFactory, "registerShortcuts", null);
__decorate([example], KeyExampleFactory, "exampleShortcutLargerCallback", null);
__decorate(
  [example],
  KeyExampleFactory,
...
export class UIExampleFactory {
  ...
  static registerRightClickMenuPopup(win) {
    ztoolkit.Menu.register(
      ...
      "before",
      win.document?.querySelector("#zotero-itemmenu-addontemplate-test"),
    );
  }
...
__decorate([example], UIExampleFactory, "registerStyleSheet", null);
__decorate([example], UIExampleFactory, "registerRightClickMenuItem", null);
__decorate([example], UIExampleFactory, "registerRightClickMenuPopup", null);
__decorate(
  [example],
  UIExampleFactory,
...
__decorate([example], UIExampleFactory, "registerExtraColumn", null);
__decorate(
  [example],
  UIExampleFactory,
...
__decorate([example], UIExampleFactory, "registerItemPaneCustomInfoRow", null);
__decorate([example], UIExampleFactory, "registerItemPaneSection", null);
__decorate([example], UIExampleFactory, "registerReaderItemPaneSection", null);
...
__decorate([example], HelperExampleFactory, "dialogExample", null);
__decorate([example], HelperExampleFactory, "clipboardExample", null);
__decorate([example], HelperExampleFactory, "filePickerExample", null);
__decorate([example], HelperExampleFactory, "progressWindowExample", null);
__decorate([example], HelperExampleFactory, "vtableExample", null);
